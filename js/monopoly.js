...
// this function is updating the money of the the player
// When the player is broke then it disappear from the game
...
//to get smile on ownProperty
    ...
    // this function is setting all the function for the next Player
...
// to take a community card randomly
...
// when a player is going over the GO cell he will earn
Monopoly.handlePassedGo = function(){
    var player = Monopoly.getCurrentPlayer();
    Monopoly.updatePlayersMoney(player,-Monopoly.moneyAtStart/10); //  add a minus th
};
